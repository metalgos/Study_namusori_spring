...
@Service
public class MemeberServiceLogic implements MemberService {


    private MemberStore memberStore;

    public MemeberServiceLogic(MemberStore memberStore) {
    ...
    public String registerMember(MemberCdo member) {
        ...
        if (foundedMember != null) {
            throw new MemberDuplicationException("memberalready exists with email : +" + email);
        }
